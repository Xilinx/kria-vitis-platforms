...
set_property PACKAGE_PIN D9 [get_ports {GPIO_IN_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_IN_tri_i[0]}]

set_property PACKAGE_PIN D13 [get_ports {GPIO_IN_tri_i[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_IN_tri_i[1]}]

set_property PACKAGE_PIN C13 [get_ports {GPIO_IN_tri_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_IN_tri_i[2]}]

set_property PACKAGE_PIN C10 [get_ports {GPIO_IN_tri_i[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_IN_tri_i[3]}]

set_property PACKAGE_PIN E9 [get_ports {GPIO_OUT_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_OUT_tri_o[0]}]
set_property SLEW SLOW [get_ports {GPIO_OUT_tri_o[0]}]
set_property DRIVE 4 [get_ports {GPIO_OUT_tri_o[0]}]

set_property PACKAGE_PIN F13 [get_ports {GPIO_OUT_tri_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_OUT_tri_o[1]}]
set_property SLEW SLOW [get_ports {GPIO_OUT_tri_o[1]}]
set_property DRIVE 4 [get_ports {GPIO_OUT_tri_o[1]}]

set_property PACKAGE_PIN E12 [get_ports {GPIO_OUT_tri_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_OUT_tri_o[2]}]
set_property SLEW SLOW [get_ports {GPIO_OUT_tri_o[2]}]
set_property DRIVE 4 [get_ports {GPIO_OUT_tri_o[2]}]

set_property PACKAGE_PIN D10 [get_ports {GPIO_OUT_tri_o[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_OUT_tri_o[3]}]
set_property SLEW SLOW [get_ports {GPIO_OUT_tri_o[3]}]
set_property DRIVE 4 [get_ports {GPIO_OUT_tri_o[3]}]
