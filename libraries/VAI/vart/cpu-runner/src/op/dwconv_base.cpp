...
const vector<string> DWConvBase<DType>::ITName = {
    "input",
    "weights",
    "bias",
};
...
template <typename DType>
DWConvBase<DType>::DWConvBase(const xir::Subgraph* subg,
...
template <typename DType>
void DWConvBase<DType>::print_param() {
...
template <typename DType>
void DWConvBase<DType>::check_param() {
...
template <typename DType>
uint64_t DWConvBase<DType>::get_workload() {
  // not consider batch
...
template <typename DType>
void DWConvBase<DType>::read_input() {
  // read img data
...
template <typename DType>
void DWConvBase<DType>::read_weights() {
...
template <typename DType>
void DWConvBase<DType>::read_bias() {
  if (has_bias_) {
...
template <typename DType>
void DWConvBase<DType>::dwconv_normal() {
...
template <typename DType>
void DWConvBase<DType>::dwconv_normal_thread() {
...
template <typename DType>
void DWConvBase<DType>::dwconv_one(int idx_dst_n, int idx_dst_h,
                                   int idx_dst_w) {
...
INSTANTIATE_TPCLASS(DWConvBase);
