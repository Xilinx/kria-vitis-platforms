...
TConv2dFix<DType>::TConv2dFix(const xir::Subgraph* subg, const xir::Op* op,
                              IMapTBs_t inputs, CPUTBPtr_t output)
    : TConv2d<DType>(subg, op, inputs, output) {
...
template <typename DType>
void TConv2dFix<DType>::print_param() {
...
template <typename DType>
void TConv2dFix<DType>::check_param() {
...
INSTANTIATE_TPCLASS(TConv2dFix);
REG_OP_INSTANCE_FUNC("transposed-conv2d-fix", TConv2dFix);
