...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins LMB_Clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins dlmb_bram_if_cntlr/LMB_Clk] [get_bd_pins dlmb_v10/LMB_Clk] [get_bd_pins ilmb_v10/LMB_Clk]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins s_axi_aresetn_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set axis_clk [ create_bd_port -dir I -type clk -freq_hz 125000000 axis_clk ]
  set_property -dict [ list \
