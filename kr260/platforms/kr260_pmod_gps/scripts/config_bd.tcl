...
#
################################################################
# This is a generated script based on design: kr260_tsn_rs485pmod
#
...
# source kr260_tsn_rs485pmod_script.tcl
...
set design_name kr260_tsn_rs485pmod
...
\
  ...
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins PS_0/pl_ps_irq0] [get_bd_pins axi_uartlite_0/interrupt]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports UART_0_txd] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins PS_0/saxihp0_fpd_aclk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins PS_0/maxihpm0_lpd_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net emio_gpio_i_0_1 [get_bd_ports PPS_in] [get_bd_pins PS_0/emio_gpio_i]
  connect_bd_net -net rst_clk_wiz_0_100M_1_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  connect_bd_net -net rx_0_1 [get_bd_ports UART_0_rxd] [get_bd_pins axi_uartlite_0/rx]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins PS_0/pl_resetn0] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  connect_bd_net -net xlslice_ttc_0_Dout [get_bd_ports fan_en_b] [get_bd_pins xlslice_ttc_0/Dout]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
