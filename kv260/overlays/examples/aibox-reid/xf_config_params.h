...
static constexpr int INPUT_PTR_WIDTH = 64;
static constexpr int OUTPUT_PTR_WIDTH = 64;
...
static constexpr int NEWWIDTH = 720; // Maximum output image width
static constexpr int NEWHEIGHT = 720;
